...
<h2><?php echo GxHtml::encode($model->getRelationLabel('postExchanges')); ?></h2>
<?php
	echo GxHtml::openTag('ul');
	foreach($model->postExchanges as $relatedModel) {
		echo GxHtml::openTag('li');
		echo GxHtml::link(GxHtml::encode(GxHtml::valueEx($relatedModel)), array('postExchange/view', 'id' => GxActiveRecord::extractPkValue($relatedModel, true)));
